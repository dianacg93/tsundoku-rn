    ...
    <View style={styles.container}>
      ...
      <View style={styles.text}>
        ...
        <Text style={styles.pad}>
          ...
          literature has been and continues to be a past time that allows me to
          see into other people's minds and learn many lessons I may have not
          learned in my day-to-day routine. As I have grown older, I have seen
          my favorite genre change many times, and at the moment I find myself
          reading self-help and business books
        </Text>
      </View>
      ...
      <View style={styles.text}>
        ...
        ></Image>
        <Text style={styles.pad}>
          Hey, I'm Shan and I have been to many places in books, some real, some
          fictional. Most of them are far away. However I feel like I own a
