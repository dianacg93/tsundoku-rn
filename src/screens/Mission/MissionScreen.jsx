		...
		<ScrollView>
			<View style={styles.container}>
				<Text style={tailwind("text-justify px-10 pl-16 pr-16")}>
					...
					<strong> best workout for your brain </strong>, and it can even <strong> improve your memory </strong>. Sure, unwinding with
					Netflix at the end of every day is relaxing and all, but regularly reading is good for your mind, body, and soul.
				</Text>
				<br />
				<Text style={tailwind("text-justify px-10 pl-16 pr-16")}>
			...
			<View style={styles.storyContainer}>
				...
				<View style={styles.storyDescription}>
					<Text style={tailwind("text justify w-screen px-10 lg:w-11/12 p-3")}>
						The writer Umberto Eco belongs to that small class of scholars who are encyclopedic, insightful, and nondull. He is the owner of
						a large personal library (containing thirty thousand books) ...
					</Text>
				</View>
				<Text
					style={tailwind("text justify w-screen p-3 font-bold text-red-500")}
					onPress={() => Linking.openURL("https://www.brainpickings.org/2015/03/24/umberto-eco-antilibrary/")}
				>
					Read More >
				</Text>
				<View style={styles.storyAuthor}>
					<Text style={tailwind("text-center lg:w-1/4 p-3 border-b ")}>by Maria Popova</Text>
				</View>
			</View>
			<View style={styles.storyContainer}>
				...
				<View style={tailwind("text justify w-screen px-10 lg:w-11/12 p-3")}>
					<Text>
						...
						librarians — even me on this very site — have touted the many health and wellness benefits of books, but has anyone every told
						you ...
					</Text>
				</View>
				<Text
					style={tailwind("text justify w-screen p-3 font-bold text-red-500")}
					onPress={() =>
						Linking.openURL("https://www.bustle.com/p/what-does-reading-do-to-your-brain-these-5-effects-are-pretty-astounding-74676")
					}
				>
					Read More >
				</Text>
				<View style={styles.storyAuthor}>
					<Text style={tailwind("text-center lg:w-1/4 p-3 border-b ")}>by Sadie Trombetta</Text>
				</View>
			</View>
			<View style={styles.storyContainer}>
				<View style={tailwind("flex flex-col lg:flex-row border-t-2 items-center pt-3")}>
				...
				<View style={styles.storyAuthor}>
					<Text style={tailwind("text-center lg:w-1/4 p-3 border-b ")}>by Chip Kidd</Text>
				</View>
			</View>
		</View>
	);
